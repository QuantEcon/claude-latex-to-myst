...
| Deep Learning | `cfbe3e9` (2026-07-06) | Most current pin (tracks this repo's `main`). |
...
- [#186](https://github.com/QuantEcon/claude-latex-to-myst/issues/186) →
  mystmd#73 — multi-row `align`/`gather` collapse to one equation number.
- mystmd#74 — fancy-list render bug (found in the Deep-Learning book).
