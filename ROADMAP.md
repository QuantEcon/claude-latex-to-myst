...
parity gap to drive down (`scripts/validate_fixture.sh`, `--against
snapshot` vs the default). Because refactor-safety rides on the snapshot,
reaching parity is *not* a precondition for starting the phases.
